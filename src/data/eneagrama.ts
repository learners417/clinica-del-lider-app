...
export const ENEAGRAMA_TIPOS: { tipo: number; nombre: string; afirmacion: string; espejo: string }[] = [
  ...
  { tipo: 5, nombre: 'El Observador', afirmacion: 'Me recargo aislándome; las personas me drenan.', espejo: 'Saber no es lo mismo que vivir. El cuerpo también es una fuente de datos.' },
